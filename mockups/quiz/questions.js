...
const QUESTIONS = [
  ...
  {
    part: 'Part 1 — Your Vibe',
    title: "What's the pace of your perfect day?",
    ...
    options: [
      { emoji: '🚴', label: 'Active and adventurous',  svg: OPTION_SCENES.q3.active },
      { emoji: '🎨', label: 'Creative and cultural',   svg: OPTION_SCENES.q3.creative },
      { emoji: '🌿', label: 'Relaxed and unhurried',   svg: OPTION_SCENES.q3.relaxed },
      { emoji: '🥂', label: 'Social and connected',    svg: OPTION_SCENES.q3.social },
    ]
  },
  {
    part: 'Part 1 — Your Vibe',
    ...
    options: [
      ...
      { emoji: '🇨🇦', label: 'Canada' },
      { emoji: '🌎', label: 'Mexico & Latin America' },
      { emoji: '🏝️', label: 'The Caribbean' },
      { emoji: '🏛️', label: 'Europe' },
      { emoji: '🇦🇺', label: 'Australia or New Zealand' },
      { emoji: '🏯', label: 'Asia' },
    ]
  },
  {
  ...
  {
    part: 'Part 2 — Your Reality',
    title: 'Will you be retiring solo or with a partner?',
    hint: '',
    type: 'single',
    cols: 3,
    useImages: true,
    sceneKey: 'q9',
    caption: 'However you roll',
    options: [
      { emoji: '🧘', label: 'Flying solo',                svg: OPTION_SCENES.q7.solo },
      { emoji: '💞', label: 'With my partner or spouse',  svg: OPTION_SCENES.q7.partner },
      { emoji: '🤷', label: 'Not sure yet',               svg: OPTION_SCENES.q7.notSure },
    ]
  },
  {
    part: 'Part 2 — Your Reality',
    ...
    options: [
      { emoji: '🗺️', label: 'Adventure and new experiences' },
      { emoji: '🫂', label: 'Community and belonging' },
      { emoji: '🕊️', label: 'Peace and simplicity' },
      { emoji: '🎯', label: 'Purpose and passion projects' },
      { emoji: '🧘', label: 'Health and wellness' },
      { emoji: '🎭', label: 'Culture, arts and creativity' },
    ]
  },
];
