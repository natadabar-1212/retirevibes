...
const PAGE_CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hood-card { background: var(--white); border-radius: 16px; padding: 32px 30px; border: 1px solid rgba(27,58,75,.07); }
  .hood-card-main { }
  .hood-vibe { display: inline-block; padding: 5px 12px; border-radius: 999px; font-size: 11px; font-weight: 600; letter-spacing: .1em; text-transform: uppercase; white-space: nowrap; margin-bottom: 12px; }
  ...
  .hood-stats { display: flex; gap: 20px; flex-wrap: wrap; align-items: baseline; }
  .hood-stat { font-size: 13px; line-height: 1.5; color: var(--warm-gray); }
...
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; font-src https://fonts.gstatic.com; img-src 'self' https://images.unsplash.com https://www.google-analytics.com https://www.googletagmanager.com data: blob:; connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com;">
...
<footer>
  <div class="footer-inner">
    <div>
      <a class="wordmark" href="/" style="font-size:20px;">Retire<em>Vibes</em></a>
      <p class="footer-tag">Good RetireVibes only.</p>
    </div>
    <div class="footer-links">
      <a href="/#destinations">Destinations</a>
      <a href="/#how-it-works">How it works</a>
      <a href="../../../../advisor-domestic.html">Find an advisor</a>
  ...
  <div class="footer-legal-links" style="max-width:1240px;margin:16px auto 0;display:flex;gap:20px;">
    <a href="../../../../privacy-policy.html" style="font-size:12px;color:rgba(255,255,255,.45);text-decoration:none;">Privacy Policy</a>
    <a href="../../../../terms-of-service.html" style="font-size:12px;color:rgba(255,255,255,.45);text-decoration:none;">Terms of Service</a>
  </div>
</footer>
